...
if __name__ == '__main__':
    ...
    parser.add_argument("--predict_path_for_solution", default=f"./algo_data/{data_type}/solutions.jsonl" , type=str, help="model output file in .jsonl format")
    ...
    parser.add_argument("--predict_path_for_test", default=f"./algo_data/{data_type}/test_cases.pkl" , type=str, help="model output file in .jsonl format")
